				...
				<div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64">
					<div className="flex flex-col gap-12 justify-center">
						...
						<p className="text-lg">
							...
							cupiditate, a, optio accusamus illo nihil voluptate eligendi dolor
							sit hic voluptatem. Sed corrupti sapiente quis beatae quidem
							incidunt, eum impedit, adipisci quae temporibus, reprehenderit
							facilis? At optio, dolorem quod debitis quaerat, corporis vitae
							hic unde dignissimos, dolore mollitia officia saepe?
						</p>
